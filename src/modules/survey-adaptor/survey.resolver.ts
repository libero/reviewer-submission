...
export class SurveyResolver {
  ...
  async submitSurveyResponse(@Args('surveyId') surveyId: string, @Args('submissionId') submissionId: string, @Args('answers') answers: Array<SurveyAnswer>): Promise<SurveyResponse> {
